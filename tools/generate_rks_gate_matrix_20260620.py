...
def build_payload() -> dict[str, object]:
    ...
    rows = with_runtime_status(build_rows(), runtime_validation)
...
def build_markdown(payload: dict[str, object]) -> str:
    ...
    lines = [
        ...
        "## Matrix",
        "",
        "| Scenario | Current RKS Status | Runtime Intake Status | Runtime Approved | Strongest Confirmed Scope | Missing Gate | Next Safe Action | Source Exists |",
        "|---|---|---|---:|---|---|---|---:|",
    ]
    for item in rows:
