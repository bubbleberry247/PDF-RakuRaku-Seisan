...
REPORT_ROOT = Path(
    ...
    r"\s51_52_current_safe_dryrun_recheck_20260622"
)
...
def main() -> int:
    ...
    runs.append(
        run_command(
            "pipeline_future_save_draft_dryrun_no_mail",
            [
                python_executable,
                "-X",
                "utf8",
    ...
    artifacts = {
        ...
        "scenario51_log_20260622": copy_artifact(LOG_DIR / "scenario_51_20260622.log", report_dir),
        "scenario52_log_20260622": copy_artifact(LOG_DIR / "scenario_52_20260622.log", report_dir),
    }
    expected_exit_codes = {
        "py_compile": {0},
        "pipeline_excel_only_dryrun_no_mail": {0},
        "pipeline_future_save_draft_dryrun_no_mail": {0},
    ...
    summary = {
        ...
        "scope": "dry-run/no-mail only; no Rakuraku registration, no draft save, no final submit, no mail",
    ...
    summary_path = report_dir / "s51_52_safe_dryrun_summary.json"
