"""
Investigate the 6 amount mismatches between original Excel and RPA output.
"""
import openpyxl
...
mismatches = [
    ...
    {"month": "R7.8", "sheet": "R7.8月分", "supplier": "山庄㈱(ボディマン)", "group": "末日", "orig": 2346189, "rpa": 2365219},
    {"month": "R7.9", "sheet": "R7.9月分", "supplier": "山庄㈱(ボディマン)", "group": "末日", "orig": 103910, "rpa": 84880},
...
for idx, mismatch in enumerate(mismatches, 1):
    ...
    if not found_rows:
        ...
        total = 0
        for r in found_rows:
            print(f"  Row {r['row']:3d}: Code={r['code']}, Amount={r['amount']:>12}, Memo={r['memo']}")
