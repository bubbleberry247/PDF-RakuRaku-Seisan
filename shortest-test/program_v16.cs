...
System.Globalization.CultureInfo.DefaultThreadCurrentUICulture = new System.Globalization.CultureInfo(Keyence.Activities.EnvironmentVariableAccessor.CultureName);
...

    {
        ...
        Keyence.WebActions.WebSingleHtmlElementAction.ClickMouseLeft(webController1, Keyence.WebActions.WebSingleHtmlElementAction.CreateSelector(Keyence.WebActions.SyntaxType.Xpath, "//input[@id='loginId']", "#root#"), Keyence.WebActions.MouseClickActionType.Click, 0, 0, 90, false);

        var string1 = Keyence.SystemActions.SystemAction.ReadPasswordFromCredential("ログインID　ETC");

        Keyence.WebActions.WebSingleHtmlElementAction.InputTextField(webController1, Keyence.WebActions.WebSingleHtmlElementAction.CreateSelector(Keyence.WebActions.SyntaxType.Xpath, "//input[@id='loginId']", "#root#"), string1, true, 0, 0, 0, true);

        Keyence.WebActions.WebSingleHtmlElementAction.ClickMouseLeft(webController1, Keyence.WebActions.WebSingleHtmlElementAction.CreateSelector(Keyence.WebActions.SyntaxType.Xpath, "//input[@id='password']", "#root#"), Keyence.WebActions.MouseClickActionType.Click, 0, 0, 90, false);

        var string2 = Keyence.SystemActions.SystemAction.ReadPasswordFromCredential("パスワード　ETC");

        Keyence.WebActions.WebSingleHtmlElementAction.InputTextField(webController1, Keyence.WebActions.WebSingleHtmlElementAction.CreateSelector(Keyence.WebActions.SyntaxType.Xpath, "//input[@id='password']", "#root#"), string2, true, 0, 0, 0, true);
